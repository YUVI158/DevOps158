...
pipeline {
    ...
    stages {
        ...
        // stage('Checkout') {
        //     steps {
        //         git branch: 'master', credentialsId: 'git-credentials', url: 'https://github.com/YUVI158/DevOps158.git'
        //     }
        // }
        stage('init'){
            steps{
                script{
                    ...
                    //sh "git clone https://github.com/YUVI158/DevOps158.git"
                }
            }
        }
        stage('config'){
        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t yuvraj158/devopsexam:${IMAGE_NAME} ."
                    }
            }
        }
      stage('test') {
        ...
        input{
            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    ...
                    sh "docker push yuvraj158/devopsexam:${IMAGE_NAME}"
                }}
